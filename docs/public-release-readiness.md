...
- TypeScript is declared as a production dependency because installed extraction uses the compiler API; the frozen lock artifact records that consumer runtime dependency.
